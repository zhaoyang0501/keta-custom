...
<dwz:paginationForm action="${contextPath }/management/opinion/opinion/list" page="${page }">
	<input type="hidden" name="search_LIKE_title" value="${param.search_LIKE_title}"/>
</dwz:paginationForm>

<form method="post" action="${contextPath }/management/opinion/opinion/list" onsubmit="return navTabSearch(this)">
	<div class="pageHeader">
		<div class="searchBar">
			<ul class="searchContent">
				<li>
					<label>问题来源：</label>
				<dwz:dic themeName="问题来源" paramName="search_LIKE_problemSource">
					<option value="">--请选择--</option>
				</dwz:dic>			
				</li>
				<li>
					<label>案件状态：</label>
				<dwz:dic themeName="案件状态" paramName="search_LIKE_opinionStatus">
					<option value="">--请选择--</option>
				</dwz:dic>			
				</li>
				<%-- <li>
			...
			<%-- <ul class="searchContent">
				...
				<li>
					<label>案件编号：</label>
					<input type="text" name="search_LIKE_id" value="${param.search_LIKE_id}" style="width: 200px;"/>		
				</li>
			</ul> --%>
	...
	<table class="table" layoutH="162" width="100%">
		...
		<tbody>
			...
			<tr target="slt_uid" rel="${item.id}">
				...
				<a iconClass="book_open" href="${contextPath }/management/mainopinion/mainopinion/view/{slt_uid}" target="navTab" title="详情"></a></td>
			</tr>
			</c:forEach>
		</tbody>
	</table>

...
<dwz:paginationForm action="${contextPath }/management/opinion/opinion/listOpinionOver2" page="${page }">
	<input type="hidden" name="search_LIKE_title" value="${param.search_LIKE_title}"/>
</dwz:paginationForm>

<form method="post" action="${contextPath }/management/opinion/opinion/listOpinionOver2" onsubmit="return navTabSearch(this)">
	...
	<table class="table" layoutH="162" width="100%">
		...
		<tbody>
			...
			<tr target="slt_uid" rel="${item.id}">
				...
				<td><a iconClass="application_view_detail" href="${contextPath }/management/opinion/opinion/view?id=${item.id}" target="dialog" width="800" height="500" title="详情"></a></td>
			</tr>
			</c:forEach>
		</tbody>
	</table>
